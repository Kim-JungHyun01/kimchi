...
public class BoardPageMaker {
	...
	public String makeSearch(int page) {
		...
		UriComponents uriComponents = UriComponentsBuilder.newInstance().queryParam("page",page).queryParam("perPageNum", cri.getPerPageNum()).queryParam("searchType", ((BoardSearchCriteria) cri).getSearchType()).queryParam("keyword", encoding(((BoardSearchCriteria) cri).getKeyword())).build();
