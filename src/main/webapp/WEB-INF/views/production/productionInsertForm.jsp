	...
	<div>
		...
		<form action="productionInsert" method="post" name="productionInsertForm" id="productionInsertForm">
			<div>
				...
				<label>계약물품제조소요일(일)</label> <input name="bom_schedule" id="bom_schedule" type="number" placeholder="계약선택" onclick="opencontractsModal()"><br>
				<label>계약수량</label> <input name="contracts_quantity" id="contracts_quantity" type="number" placeholder="계약선택" onclick="opencontractsModal()"><br>
			...
			<button type="button" onclick="btnsumbit()">생산계획등록</button>
