...
<div class="quixnav">
   <div class="quixnav-scroll">
      <ul class="metismenu" id="menu">
         ...
         <c:if test="${userlogin.user_department eq '관리자' || userlogin.user_department eq '자재부서' || userlogin.user_department eq '구매부서' || userlogin.user_department eq '생산부서' || partlogin != null}">
