...
<div class="content-body">
	<form method="post" action="itemUpdate" name="itemUpdateForm" id="itemUpdateForm">
		<table border="1">
			...
			<tr>
				<td>물품 첨부파일</td>
				<td><input name="attachment_no" id="attachment_no" type="hidden" value="${item.attachment_no}" onclick="openModal()">
				<input name="attachment_name" id="attachment_name" type="text" value = "${att.attachment_name }" onclick="openModal()">
				<button type = "button" onclick="btnattreset()">첨부파일초기화</button></td>
			</tr>
		</table>
		<div>
