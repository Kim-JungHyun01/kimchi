...
<script>
	...
	function addRow() {
		...
		// 셀에 HTML 추가
		cell1.innerHTML = '<input name="ma_stockQuantity" id="ma_stockQuantity" type="hidden" onclick="openmaModal()">
							+ '<input name="ma_specifications" id="ma_specifications" type="hidden" onclick="openmaModal()">'
							+ '<input name="ma_price" id="ma_price" type="hidden" onclick="openmaModal()">'
							+ '<input name="ma_specifications" id="ma_specifications" type="hidden" onclick="openmaModal()">'
							+ '<input name="ma_id" id="ma_id" onclick="openmaModal()" placeholder="자재선택">';
		cell2.innerHTML = '<input name="ma_category" id="ma_category" onclick="openmaModal()" placeholder="자재선택">';
		cell3.innerHTML = '<input name="ma_name" id="ma_name" onclick="openmaModal()" placeholder="자재선택">';
		cell4.innerHTML = '<input name="ma_origin" id="ma_origin" onclick="openmaModal()" placeholder="자재선택">';
		cell5.innerHTML = '<input name="ma_unit" id="ma_unit" onclick="openmaModal()" placeholder="자재선택">';
		cell6.innerHTML = '<input name="ma_weight" id="ma_weight" onclick="openmaModal()" placeholder="자재선택">';
		cell7.innerHTML = '<input id="bom_ma_amount" name="bom_ma_amount" type="number">';
		cell8.innerHTML = '<select id="bom_ma_process" name="bom_ma_process" required>'
			...
			<div>
				...
				<form action="bom_maInsert" method="post" id="bom_maInsertForm"
					...
					<table id="bomInsertTable">
						...
						<tr>
							<td><input name="ma_stockQuantity" id="ma_stockQuantity"
								type="hidden" onclick="openmaModal()"> <input
								name="ma_specifications" id="ma_specifications" type="hidden"
								onclick="openmaModal()"> <input name="ma_price"
								id="ma_price" type="hidden" onclick="openmaModal()"><input
								name="ma_specifications" id="ma_specifications" type="hidden"
								onclick="openmaModal()"> <input name="ma_id" id="ma_id"
