...
<script>
	...
	function checkdate() {
	    ...
	    if (obtain_deliveryDate > production_deliveryDate) {
	        alertAndReset(form.production_deliveryDate, "생산계획 이전의 날짜여야 합니다.");
	        return;
	    }
	    ...
	    if (obtain_deliveryDate > today) {
	        alertAndReset(form.obtain_deliveryDate, "3일이내에 조달해야합니다.");
	        return;
	    }
	...
	<div>
		...
		<form action="obtainInsert" method="post" id="obtainInsertForm" name="obtainInsertForm">
			...
			<div>
				...
				<label>자재단가</label> <input name="ma_price" id="ma_price" type="number" placeholder="자재선택" oninput="calnum()"><br>
			...
			<div>
				<button type="button" onclick="btnsumbit()">조달계획등록</button>
