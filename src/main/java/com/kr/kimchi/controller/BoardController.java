...
public class BoardController {
	...
	public void listAll(@RequestParam(defaultValue = "1") int pageNum, Model model) throws Exception {
		...
		public void readPage(@RequestParam("board_no") int board_no,@ModelAttribute("cri") BoardCriteria cri ,Model model) throws Exception {
		...
		public String remove(@RequestParam("board_no") int board_no,
				BoardCriteria cri , RedirectAttributes rttr)throws Exception {
		...
		public void modifyPagingGET(@RequestParam("board_no") int board_no, @ModelAttribute("cri") BoardCriteria cri,Model model) throws Exception {
		...
		public String modifyPagingPOST(BoardVO board_no, BoardCriteria cri,
				RedirectAttributes rttr) throws Exception {
